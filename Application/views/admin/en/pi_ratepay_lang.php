...
$aLang = array(
    ...
    'SHOP_MODULE_GROUP_PI_RATEPAY_AUSTRIA'     => 'Austria',
    'SHOP_MODULE_GROUP_PI_RATEPAY_SWITZERLAND' => 'Switzerland',
    'SHOP_MODULE_GROUP_PI_RATEPAY_NETHERLAND'  => 'Netherlands',
    'SHOP_MODULE_blRPLogging'                   => 'Log operation',
    ...
    'SHOP_MODULE_blRPInvoiceActive'             => 'Ratepay Rechnung active',
    'SHOP_MODULE_blRPInvoiceSandbox'            => 'Sandbox (Testmode)',
    'SHOP_MODULE_sRPInvoiceProfileId'           => 'Profil ID',
    'SHOP_MODULE_sRPInvoiceSecret'              => 'Security Code',
    'SHOP_MODULE_blRPInstallmentActive'         => 'Ratepay Ratenzahlung active',
    'SHOP_MODULE_blRPInstallmentSandbox'        => 'Sandbox (Testmode)',
    ...
    'SHOP_MODULE_blRPInstallment0Active'         => 'Ratepay 0% Financing active',
    'SHOP_MODULE_blRPInstallment0Sandbox'        => 'Sandbox (Testmode)',
    ...
    'SHOP_MODULE_blRPElvActive'                 => 'Ratepay SEPA-Lastschrift active',
    'SHOP_MODULE_blRPElvSandbox'                => 'Sandbox (Testmode)',
    'SHOP_MODULE_blRPElvIbanOnly'               => 'Only allow IBAN',
    'SHOP_MODULE_sRPElvProfileId'               => 'Profil ID',
    'SHOP_MODULE_sRPElvSecret'                  => 'Security Code',
    'SHOP_MODULE_blRPAustriaInvoice'            => 'Ratepay Rechnung active',
    'SHOP_MODULE_blRPAustriaInvoiceSandbox'     => 'Sandbox (Testmode)',
    'SHOP_MODULE_sRPAustriaInvoiceProfileId'    => 'Profil ID',
    'SHOP_MODULE_sRPAustriaInvoiceSecret'       => 'Security Code',
    'SHOP_MODULE_blRPAustriaInstallment'        => 'Ratepay Ratenzahlung active',
    'SHOP_MODULE_blRPAustriaInstallmentSandbox' => 'Sandbox (Testmode)',
    ...
    'SHOP_MODULE_blRPAustriaInstallment0'        => 'Ratepay 0% Financing active',
    'SHOP_MODULE_blRPAustriaInstallment0Sandbox' => 'Sandbox (Testmode)',
    ...
    'SHOP_MODULE_blRPAustriaElv'                => 'Ratepay SEPA-Lastschrift active',
    'SHOP_MODULE_blRPAustriaElvSandbox'         => 'Sandbox (Testmode)',
    'SHOP_MODULE_sRPAustriaElvProfileId'        => 'Profil ID',
    'SHOP_MODULE_sRPAustriaElvSecret'           => 'Security Code',
    'SHOP_MODULE_blRPSwitzerlandInvoice'        => 'Ratepay Rechnung active',
    'SHOP_MODULE_blRPSwitzerlandInvoiceSandbox' => 'Sandbox (Testmode)',
    'SHOP_MODULE_sRPSwitzerlandInvoiceProfileId'=> 'Profil ID',
    'SHOP_MODULE_sRPSwitzerlandInvoiceSecret'   => 'Security Code',
    'SHOP_MODULE_blRPNetherlandInvoice'         => 'Ratepay Rechnung active',
    'SHOP_MODULE_blRPNetherlandInvoiceSandbox'  => 'Sandbox (Testmode)',
    'SHOP_MODULE_sRPNetherlandInvoiceProfileId' => 'Profil ID',
    'SHOP_MODULE_sRPNetherlandInvoiceSecret'    => 'Security Code',
    'SHOP_MODULE_blRPNetherlandElv'             => 'Ratepay SEPA-Lastschrift active',
    'SHOP_MODULE_blRPNetherlandElvSandbox'      => 'Sandbox (Testmode)',
    'SHOP_MODULE_sRPNetherlandElvProfileId'     => 'Profil ID',
    'SHOP_MODULE_sRPNetherlandElvSecret'        => 'Security Code',
    'PI_RATEPAY_CONFIGTEST_INVOICE'             => 'Connection test for Ratepay Rechnung',
    'PI_RATEPAY_CONFIGTEST_INSTALLMENT'         => 'Connection test for Ratepay Ratenzahlung',
    'PI_RATEPAY_CONFIGTEST_INSTALLMENT0'        => 'Connection test for Ratepay 0% Financing',
    'PI_RATEPAY_CONFIGTEST_ELV'                 => 'Connection test for Ratepay SEPA-Lastschrift',
    ...
    'PI_RATEPAY_LOGGING_DELETE_CONFIRM'        => "Are you sure that you want to delete all log entries older than ",
    'PI_RATEPAY_LOGGING_DELETE_CONFIRM2'       => " days?",
    'PI_RATEPAY_LOGGING_TEXTDAYS'              => "Delete all entries whichare older than ",
    'PI_RATEPAY_LOGGING_SUCCESS'               => "Deleting was successful.",
    ...
    'PI_RATEPAY_ELV_SETTINGS'                  => "Debit Settings",
    'PI_RATEPAY_ELV_SETTINGS_TITLE'            => "Ratepay SEPA-Lastschrift Settings",
