...
$aLang = array(
    ...
    'PI_RATEPAY_PROFILE_SAVED'           => "Configuration saved",
    'PI_RATEPAY_PROFILE_PAYMENT_FOR'     => "Ratepay Payment for",

    'PI_RATEPAY_PROFILE_COUNTRY_DE'      => "Germany",
    'PI_RATEPAY_PROFILE_COUNTRY_AT'      => "Austria",
    'PI_RATEPAY_PROFILE_COUNTRY_CH'      => "Switzerland",
    'PI_RATEPAY_PROFILE_COUNTRY_NL'      => "Netherlands",

    'PI_RATEPAY_PROFILE_MERCHANTNAME'    => "Merchant",
    'PI_RATEPAY_PROFILE_MERCHANTSTATUS'  => "Merchant status",
    'PI_RATEPAY_PROFILE_SHOPNAME'        => "Shop",
    'PI_RATEPAY_PROFILE_INVOICE'         => "Invoice",
    'PI_RATEPAY_PROFILE_INSTALLMENT'     => "Installment",
    'PI_RATEPAY_PROFILE_ELV'             => "Direct Debit",
    'PI_RATEPAY_PROFILE_PREPAYMENT'      => "Prepayment",
    'PI_RATEPAY_PROFILE_ACTIVATION'      => "Activation",
    'PI_RATEPAY_PROFILE_ELIGIBILITY'     => "Eligibility",
    'PI_RATEPAY_PROFILE_LIMIT'           => "Basket limit (min/max)",
    'PI_RATEPAY_PROFILE_DELIVERYADDRESS' => "Differing Shipping Address",
    'PI_RATEPAY_PROFILE_B2B'             => "Business Customer Approval (B2B)",
    ...
    'PI_RATEPAY_PROFILE_SETTINGS_ACTIVE'       => "active",
    'PI_RATEPAY_PROFILE_SETTINGS_PROFILEID'    => "Profil ID",
    'PI_RATEPAY_PROFILE_SETTINGS_SECURITYCODE' => "Security Code",
    'PI_RATEPAY_PROFILE_SETTINGS_TITLE'        => "Designation (im Checkout)",
    'PI_RATEPAY_PROFILE_SETTINGS_SANDBOX'      => "Sandbox",
    'PI_RATEPAY_PROFILE_SETTINGS_URL'          => "Data protection URL",
    'PI_RATEPAY_PROFILE_SETTINGS_LOGGING'      => "Logging",
    'PI_RATEPAY_PROFILE_SETTINGS_WHITELABEL'   => "Whitelabel",
    'PI_RATEPAY_PROFILE_SETTINGS_DUEDATE'      => "Due after",
    'PI_RATEPAY_PROFILE_SETTINGS_DUEDATE_DAY'  => "Days",
